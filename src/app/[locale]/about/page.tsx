...
export default async function AboutPage({
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      <h1 className="font-display text-5xl text-ink">{t("about")}</h1>
      <p className="mt-4 max-w-2xl leading-relaxed text-ink-soft">{tAbout("intro")}</p>

      {board.length > 0 && (
        <section className="mt-14">
          <h2 className="font-display text-xl text-ink">{t("aboutBoard")}</h2>
      ...
      {staff.length > 0 && (
        <section className="mt-14">
          <h2 className="font-display text-xl text-ink">{t("aboutTeam")}</h2>
      ...
      {reports.length > 0 && (
        <section className="mt-14">
          <h2 className="font-display text-xl text-ink">{t("aboutReports")}</h2>
