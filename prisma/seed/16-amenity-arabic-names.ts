...
const ARABIC: Record<string, string> = {
  ...
  // Second batch: the rest of the tags that describe an actual facility or
  // service. Deliberately excluded are the ~10 tags that are cuisines filed
  // as amenities (arabic, italian, japanese, sushi, pizza, mediterranean,
  // international, american, turkish, asian-cuisine) — translating those
  // would settle them into a vocabulary they do not belong in. They should be
  // moved to the cuisine table or dropped, which is the association's call.
  "full-bar": "بار متكامل",
  bar: "بار",
  pub: "حانة",
  "sports-bars": "بار رياضي",
  "banquet-facility": "قاعة مناسبات",
  "wedding-and-engagement": "أعراس وخطوبة",
  parties: "حفلات",
  "free-parking": "مواقف مجانية",
  "parking-available": "مواقف متاحة",
  "street-parking": "مواقف على الشارع",
  "free-off-street-parking": "مواقف مجانية خارج الشارع",
  "valet-parking": "خدمة صف السيارات",
  "diet-food": "أطباق دايت",
  "free-wifi": "واي فاي مجاني",
  takeout: "طلبات خارجية",
  takeaway: "طلبات خارجية",
  "taxi-service": "خدمة تاكسي",
  "family-friendly": "مناسب للعائلات",
  "family-style": "طعام عائلي",
  "kids-zone": "منطقة أطفال",
  "highchairs-available": "كراسي أطفال",
  "non-smoking-restaurant": "مطعم لغير المدخنين",
  "non-smoking-restaurants": "مطعم لغير المدخنين",
  "smoking-restaurant": "مطعم للمدخنين",
  "wine-and-beer": "نبيذ وبيرة",
  wine: "نبيذ",
  beer: "بيرة",
  "no-alcohol": "بدون مشروبات كحولية",
  coffee: "قهوة",
  cafe: "مقهى",
  drinks: "مشروبات",
  brunch: "فطور متأخر",
  "late-night": "مفتوح حتى وقت متأخر",
  "formal-dress": "لباس رسمي",
  mastercard: "ماستركارد",
  "american-express": "أمريكان إكسبرس",
  "digital-payments": "دفع إلكتروني",
  "dance-floor": "حلبة رقص",
  "live-music": "موسيقى حية",
  television: "تلفزيون",
  "free-delivery": "توصيل مجاني",
  "drive-thru": "خدمة السيارات",
  "private-room-dining": "غرف طعام خاصة",
  "private-dining": "طعام خاص",
  ...
  "wheelchair-accessible": "مدخل لذوي الإعاقة",
  "self-service": "خدمة ذاتية",
  "study-area": "منطقة دراسة",
  cozy: "أجواء دافئة",
  diner: "مطعم شعبي",
  "on-site-services": "خدمات في الموقع",
};
