                ...
                <div className="shrink-0">
                  {canStart || canResume ? (
                    <form action={startAssessmentAndRedirect.bind(null, restaurant.id)}>
                      {/* Starting an assessment creates a row and redirects,
                          which takes a moment — long enough for a second click
                          to make a second session if nothing says the first
                          registered. */}
                      <SubmitButton
